...
public class SourceDirectory {
	 ...
	 * @return JPA information contained in given directory.
	 * @throws ParsingException if there is a syntax error while processing the directory
	 */
	public static JpaInfo getJpaInfo(File srcDir) throws ParsingException {
		SourceDirectory _srcDir = new SourceDirectory(srcDir);
		Set<String> classes = _srcDir.getJpaClasses();
		String[] classArray = classes.toArray(new String[classes.size()]);
		return new JpaInfo(classArray);
	}
	// =========================================================================

	// INSTANCE SCOPE ==========================================================
	private final Set<String> jpaClasses = new LinkedHashSet<String>();
	...
	private void parseFile(File file) throws ParsingException {
		...
		jpaClasses.addAll(cv.getJpaClasses());
	}
	 ...
	 */
	private Set<String> getJpaClasses() {
		return jpaClasses;
	}
	// =========================================================================
}
