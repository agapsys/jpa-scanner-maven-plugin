...
* The plugin will scan project's source directory in order to get all JPA classes and list them in a generated file called `jpa-info.xml` (file will be stored under `META-INF`)
* goal `create` will be responsible by generating `META-INF/jpa-info.xml`
	...
	<build>
		<plugins>
			<plugin>
				...
				<artifactId>jpa-scanner-plugin</artifactId>
...
* Generated `META-INF/jpa-info.xml`:
```xml
<jpaInfo>
  <classes>
    <class>com.example.entities.Entity1</class>
    <class>com.example.entities.Converter1</class>
  </classes>
</jpaInfo>
...
<persistence version="2.1" xmlns="http://xmlns.jcp.org/xml/ns/persistence" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://xmlns.jcp.org/xml/ns/persistence http://xmlns.jcp.org/xml/ns/persistence/persistence_2_1.xsd">
	<persistence-unit name="com.example_sample-lib_jar_1.0-SNAPSHOTPU" transaction-type="RESOURCE_LOCAL">
		<!-- classes will be included by resource filter plugin. This variable was set in `filterProperty` configuration of `list-jpa-classes` goal -->
		${resource.filter.var}
	</persistence-unit>
</persistence>
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/xsd/maven-4.0.0.xsd">
	...
	<dependencies>
		...
		<!-- This library contains a `META-INFO/jpa-info.xml` generated by jpa-scanner-plugin:create-jpa-info-xml -->
		<dependency>
			<groupId>com.example</groupId>
			<artifactId>sample-lib</artifactId>
			<version>1.0-SNAPSHOT</version>
